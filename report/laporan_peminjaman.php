...
?>
 <div class="container">
  ...
  <div class="row">
          ...
          <table class="table table-bordered table-hover table-striped" id="datatables">
            ...
            <tbody>
                ...
                ?>
                 ...
                 <td align="center">
                    <a href="report/cetak_peminjaman.php?id_pinjam=<?php echo $data->id_pinjam; ?>" target="_blank">
       ...
       <a href="report/export_excel_peminjaman.php" target="_blank">
  ...
  <div class="modal-body">
        <form action="report/cetak_peminjaman.php" method="POST" target="_blank">
          <table>
            <tr>  
              <td>
            ...
            <tr>
              ...
              <td></td>
              <td>
                  <input type="submit" name="cetak_pinjam" class="btn btn-primary btn-sm" value="Cetak">
              </td>
            </tr>

          </table>
          <div class="modal-footer">
            <a href="report/cetak_peminjaman.php" target="_blank" class="btn btn-primary btn-sm">Cetak Data
            </a>
          </div>
         </form>        
     </div>
