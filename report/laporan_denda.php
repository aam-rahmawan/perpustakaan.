          ...
          <table class="table table-bordered table-hover table-striped" id="datatables">
            ...
            <tbody>
                ...
                ?>
                 ...
                 <td align="center">
                    <a href="report/cetak_denda.php?id_pinjam=<?php echo $data->id_pinjam; ?>" target="_blank">
           ...
           <tr>
           <th colspan="4"><center>Jumlah Denda</center></th>                
           
      <td colspan="3" name="jumlah" id="jumlah"> 
<?php
echo "$jumlah";
?>  
  </td>
       ...
       <a id="cetak_data" data-toggle="modal" data-target="#cetak" target="_blank">
          <button  class="btn btn-default" style="margin-bottom: 5px;"><i class="fa fa-print"></i>Cetak Data</button>
       <a href="report/export_excel_denda.php" target="_blank">
  ...
  <div class="modal-body">
        <form action="report/cetak_denda.php" method="POST" target="_blank">
          <table>
            <tr>  
              <td>
            ...
            <tr>
              ...
              <td></td>
              <td>
                  <input type="submit" name="cetak_denda" class="btn btn-primary btn-sm" value="Cetak">
              </td>
            </tr>

          </table>
          <div class="modal-footer">
            <a href="report/cetak_denda.php" target="_blank" class="btn btn-primary btn-sm">Cetak Data
            </a>
          </div>
         </form>        
     </div>
